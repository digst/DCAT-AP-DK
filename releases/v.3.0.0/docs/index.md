...
<pre class="metadata">
Title: DCAT-AP-DK 3.0.0: Dansk anvendelsesprofil til beskrivelse af datasæt og datakataloger 
Status: LD
URL: https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/
...
Abstract: 'Dansk anvendelsesprofil til beskrivelse af datasæt og datakataloger (DCAT-AP-DK 3.0.0)' .
...
Denne anvendelsesprofil er også tilgængelig i disse ikke-normative formater: [XMI](https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/uml-xmi).
DCAT-DK vokabularet for de danske tilføjelser er desuden tilgængeligt i [RDF] (https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/rdf)<br>
Namespace: https://data.gov.dk/model/profile/dcat-ap-dk/

<h1>DCAT-AP-DK 3.0.0: Dansk anvendelsesprofil til beskrivelse af datasæt og datakataloger </h1>
...
* Eksempler:  
	[https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/examples](https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/examples)

* Ofte stillede spørgsmål (FAQ):
	[https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/faq](https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/faq)
...
<br>[Gå til klassen Katalogpost](https://digst.github.io/DCAT-AP-DK/releases/v.3.0.0/docs/#klasse-katalogpost-catalog-record)
...
DCAT-AP-DK 3.0.0 er i overensstemmelse med DCAT-AP 3.0.1. Metadatabeskrivelser af datasæt og datakataloger, der overholder DCAT-AP-DK, overholder også DCAT-AP. 
...
Se oversigt over anvendte namespaces i bilaget [Namespaces](https://digst.github.io/DCAT-AP-DK/releases/v.3.0.0/docs/#namespaces)
...
<img src="img/Illustration-DCAT-AP-DK-v3.0.0-UML-mandatory.svg" alt="Diagram som viser obligatoriske klasser samt obligatoriske egenskaber for disse klasser (minimumsmodellen)">

### Diagram med obligatoriske og anbefalede elementer
[DCAT-AP-DK-visning 2](https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/views/mandatory%2Brecommended)
...
<!-- <img src="img/Illustration-DCAT-AP-DK-v3.0.0-UML-recommended.svg" alt="Diagram som viser obligatoriske/anbefalede klasser samt obligatoriske/anbefalede egenskaber"> -->
<p class="center"><a href="img/Illustration-DCAT-AP-DK-v3.0.0-UML-recommended.svg"><img src="img/Illustration-DCAT-AP-DK-v3.0.0-UML-recommended.svg" alt="Diagram som viser obligatoriske/anbefalede klasser samt obligatoriske/anbefalede egenskaber"></a></p>

### Diagram med alle elementer  
Den fulde anvendelsesprofil DCAT-AP-DK v.3.0.0 visualiseret med UML-diagram  (alle obligatoriske, anbefalede og valgfrie elementer).

<p class="center"><a href="img/Illustration-DCAT-AP-DK-v3.0.0-UML.svg"><img src="img/Illustration-DCAT-AP-DK-v3.0.0-UML.svg" alt="Illustration af DCAT-AP-DK v.3.0.0 UML"></a></p>
...
### Tilføjelser
Følgende elementer er blevet tilføjet i DCAT-AP-DK 3.0.0 ift. DCAT-AP 3.0.1:
...
DCAT anvendes allerede i danske specifikationer - fx i [Fælles sprog for datakvalitet](https://arkitektur.digst.dk/FC3A6lles-sprog-for-datakvalitet) og Standard for beskrivelse af it-systemer [SYS-AP](https://digst.github.io/IT-System-AP/SYS-AP/docs/) og [archvSYS-AP](https://digst.github.io/IT-System-AP/archvSYS-AP/docs/). 
...
Find en rapport over DCAT-AP-profiler (fra 2018) samt øvrige relevante links i afsnittet [Referencer](https://digst.github.io/DCAT-AP-DK/releases/v.3.0.0/docs/#referencer). 
...
<img src="img/Katalog.svg" alt="Katalog">
<dl class="def">
<dt>URI</dt>
...
<img src="img/Katalogpost.svg" alt="Katalogpost">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/dcat#CatalogRecord</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Datasaet.svg" alt="Datasæt">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/dcat#Dataset</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Distribution.svg" alt="Distribution">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/dcat#Distribution</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Datatjeneste.svg" alt="Datatjeneste">
<dl class="def">
<dt>URI</dt>
...
<img src="img/Datasaetserie.svg" alt="Datasætserie">
<dl class="def">
<dt>URI</dt>
...
## Klasse: Aktør (Agent) 
<img src="img/Aktoer.svg" alt="Aktør">
<dl class="def">
<dt>URI</dt>
<dd>http://xmlns.com/foaf/0.1/Agent</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Organisation.svg" alt="Organisation">
<dl class="def">
<dt>URI</dt>
...
<img src="img/Begrebssystem.svg" alt="Begrebssystem">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/2004/02/skos/core#ConceptScheme</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Begreb.svg" alt="Begreb">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/2004/02/skos/core#Concept</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Checksum.svg" alt="Checksum">
<dl class="def">
<dt>URI</dt>
<dd>http://spdx.org/rdf/terms#Checksum</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Identifikator.svg" alt="Identifikator">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/adms#Identifier</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Licensdokument.svg" alt="Licensdokument">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/LicenseDocument</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Lokation.svg" alt="Lokation">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/Location</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Periode.svg" alt="Periode">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/PeriodOfTime</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Frekvens.svg" alt="Frekvens">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/Frequency</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/LingvistiskSystem.svg" alt="Lingvistisk system">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/LinguisticSystem</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Medietype.svg" alt="Medietype">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/MediaType</dd>
<dt>Anvendelsesnote (da) </dt>
...
## Klasse: Rolle (Role) 
<img src="img/Rolle.svg" alt="Rolle">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/dcat#Role</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Proveniensudsagn.svg" alt="Proveniensudsagn">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/ProvenanceStatement</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Rettighedsudsagn.svg" alt="Rettighedsudsagn">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/RightsStatement</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Dokument.svg" alt="Dokument">
<dl class="def">
<dt>URI</dt>
...
<img src="img/Specifikation.svg" alt="Specifikation">
<dl class="def">
<dt>URI</dt>
<dd>http://purl.org/dc/terms/Standard</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/VirtueltVisitkort.svg" alt="Virtuelt visitkort">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/2006/vcard/ns#Kind</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Aktivitet.svg" alt="Aktivitet">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/prov#Activity</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Retskilde.svg" alt="retskilde">
<dl class="def">
<dt>URI</dt>
<dd>http://data.europa.eu/eli/ontology#LegalResource</dd>
<dt>Definition (da)</dt>
...
<img src="img/KatalogiseretRessource.svg" alt="katalogiseret ressource">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/dcat#Resource</dd>
<dt>Anvendelsesnote (da)</dt>
...
<img src="img/Politik.svg" alt="Politik">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/odrl/2/Policy</dd>
<dt>Definition (da)</dt>
...
<img src="img/Kreditering.svg" alt="Kreditering">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/prov#Attribution</dd>
<dt>Definition (da)</dt>
...
<img src="img/Forvaltningsopgave.svg" alt="Forvaltningsopgave DK">
<dl class="def">
<dt>URI</dt>
...
<img src="img/Kvalitetsannotation.svg" alt="Kvalitetsannotation DK">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/ns/dqv#QualityAnnotation</dd>
<dt>Anvendelsesnote (da) </dt>
...
<img src="img/Dimension.svg" alt="Dimension">
<dl class="def">
<dt>URI</dt>
<dd>https://www.w3.org/ns/dqv#Dimension</dd>
<dt>Definition (da)</dt>
...
<img src="img/Personoplysningskategori.svg" alt="Personoplysningskategori DK">
<dl class="def">
<dt>URI</dt>
...
<img src="img/Fortrolighedsgrad.svg" alt="Fortrolighedsgrad DK">
<dl class="def">
<dt>URI</dt>
...
<img src="img/Tidspunkt.svg" alt="Tidspunkt">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/2006/time#Instant </dd>
<dt>Definition (da)</dt>
...
<img src="img/Literal.svg" alt="Literal">
<dl class="def">
<dt>URI</dt>
<dd>http://www.w3.org/2000/01/rdf-schema#Literal</dd>
<dt>Definition (da)</dt>
...
<img src="img/Ressource.svg" alt="Ressource">
<dl class="def">
<dt>URI</dt>
...
Indeholder følgende [udfaldsrum](https://data.gov.dk/concept/profile/conf-eu-nato-types):
...
* FDA: Fælles sprog for datakvalitet: [https://arkitektur.digst.dk/metoder/faelles-sprog-datakvalitet](https://arkitektur.digst.dk/FC3A6lles-sprog-for-datakvalitet)
...
Find eksemplerne her: [https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/examples](https://github.com/digst/DCAT-AP-DK/tree/master/releases/v.3.0.0/examples)
...
<p class="center"><a href="img/Illustration-DCAT-AP-DK-v3.0.0-UML.svg"><img src="img/Illustration-DCAT-AP-DK-v3.0.0-UML.svg" alt="Illustration af DCAT-AP-DK 3.0.0 UML"></a></p>
...
<p class="center"><a href="img/Illustration-DCAT-DK-v2.0.0-UML.svg"><img src="img/Illustration-DCAT-DK-v2.0.0-UML.svg" alt="Illustration af DCAT-DK 2.0.0 UML"></a></p>
...
<p class="center"><a href="img/Illustration-Begrebsmodel-for-datasæt-og-datakataloger-v2.0.0.svg"><img src="img/Illustration-Begrebsmodel-for-datasæt-og-datakataloger-v2.0.0.svg" alt="Illustration af Begrebsmodel for datasæt v2.0.0 "></a></p>
...
<table class="term-table">
 ...
 <tr><td>aktør</td><td>objekt, der deltager i en aktivitet</td><td>&nbsp;</td><td>FORVIR Topontologi</td><td>&nbsp;nej</td><td>agent </td></tr>  
...
[https://www.arkitektur.digst.dk/](arkitektur.digst.dk)
