...
Anvendelse af stereotyperne 'Optional', 'Recommended' og 'Mandatory' er  fastlagt af EU, og hvad de betyder kan du læse om i Kapitel 5 i DCAT-AP: https://semiceu.github.io/DCAT-AP/releases/3.0.1/#specterminology
...
Læs mere her: https://www.w3.org/TR/vocab-dcat-3/#quality-information; https://www.w3.org/TR/vocab-dqv/; https://arkitektur.digst.dk/metoder/faelles-sprog-datakvalitet;  https://github.com/w3c/dxwg/wiki/Quality-documentation
...
Se denne udgivelse om emnet: [Usage guide on Datasets, Distributions and Data Services](https://semiceu.github.io/DCAT-AP/releases/3.0.1/#usage-guide-on-datasets-distributions-and-data-services)

### Hvad er en datasætserie og hvordan bruges den?
Se denne udgivelse om emnet: [Usage guide on Dataset Series](https://semiceu.github.io/DCAT-AP/releases/3.0.1/#usage-guide-on-dataset-series)
