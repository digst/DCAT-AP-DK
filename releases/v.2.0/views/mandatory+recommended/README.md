...
|destinationsside (landing page)|http://www.w3.org/ns/dcat#landingPage	(http://xmlns.com/foaf/0.1/Document)|Denne egenskab angiver en webside som giver adgang til datasættet, dets distributioner og/eller yderligere information. 
		Egenskaben bør pege på en webside hos den oprindelige dataudstiller - ikke en side eller et websted hos tredjepart, såsom en aggregator.| 0..*|	 Anbefalet|
